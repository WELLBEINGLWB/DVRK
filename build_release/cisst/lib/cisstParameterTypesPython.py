...
_cisstParameterTypesPython.endl_cb_ptr_swigconstant(_cisstParameterTypesPython)
...
_cisstParameterTypesPython.ends_cb_ptr_swigconstant(_cisstParameterTypesPython)
...
_cisstParameterTypesPython.flush_cb_ptr_swigconstant(_cisstParameterTypesPython)
...
class prmPositionJointSet(prmMotionBase):
    ...
    def __init__(self, *args):
        ...
        __init__(prmPositionJointSet self, vctBoolVec const & mask, vctDoubleVec const & goal, vctDoubleVec const & velocity, vctDoubleVec const & acceleration, vctDoubleVec const & deceleration) -> prmPositionJointSet
        """
