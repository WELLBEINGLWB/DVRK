...
// cisst version: 1.0.9
// source file: /home/jiameng/catkin_dvrk/src/cisst-saw/cisst/cisstMultiTask/code/../mtsParameterTypes.cdg
...
void mtsDescriptionComponent::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void mtsDescriptionComponent::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
...
std::string mtsDescriptionComponent::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
...
double mtsDescriptionComponent::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsDescriptionComponentClass::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<std::string >::SerializeBinary(this->ClassName, outputStream__cdg);
...
void mtsDescriptionComponentClass::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsDescriptionComponentClass::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ClassName);
...
double mtsDescriptionComponentClass::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ClassName);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsDescriptionInterface::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<std::string >::SerializeBinary(this->ProcessName, outputStream__cdg);
    cmnData<std::string >::SerializeBinary(this->ComponentName, outputStream__cdg);
...
void mtsDescriptionInterface::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsDescriptionInterface::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
...
double mtsDescriptionInterface::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsDescriptionIntefaceFullName::SerializeRaw(std::ostream & outputStream__cdg) const
{
    cmnSerializeRaw(outputStream__cdg, this->ProcessName);
    cmnSerializeRaw(outputStream__cdg, this->ComponentName);
...
void mtsDescriptionIntefaceFullName::DeSerializeRaw(std::istream & inputStream__cdg)
{
    cmnDeSerializeRaw(inputStream__cdg, this->ProcessName);
    cmnDeSerializeRaw(inputStream__cdg, this->ComponentName);
...
void mtsDescriptionIntefaceFullName::ToStream(std::ostream & outputStream__cdg) const
{
    outputStream__cdg << this->HumanReadable();
}

void mtsDescriptionIntefaceFullName::ToStreamRaw(std::ostream & outputStream__cdg, const char delimiter__cdg, bool headerOnly__cdg, const std::string & headerPrefix__cdg) const
{
    if (headerOnly__cdg) {
        outputStream__cdg << cmnData<mtsDescriptionIntefaceFullName >::SerializeDescription(*this, delimiter__cdg, headerPrefix__cdg);
    } else {
        cmnData<mtsDescriptionIntefaceFullName >::SerializeText(*this, outputStream__cdg, delimiter__cdg);
    }
}
/* source line: 110 */
/* source line: 115 */
...
/* data functions */
void mtsDescriptionIntefaceFullName::Copy(const mtsDescriptionIntefaceFullName & source__cdg) {
    cmnData<std::string >::Copy(this->ProcessName, source__cdg.ProcessName);
    cmnData<std::string >::Copy(this->ComponentName, source__cdg.ComponentName);
    cmnData<std::string >::Copy(this->InterfaceName, source__cdg.InterfaceName);
}
void mtsDescriptionIntefaceFullName::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<std::string >::SerializeBinary(this->ProcessName, outputStream__cdg);
    cmnData<std::string >::SerializeBinary(this->ComponentName, outputStream__cdg);
    cmnData<std::string >::SerializeBinary(this->InterfaceName, outputStream__cdg);
}
void mtsDescriptionIntefaceFullName::DeSerializeBinary(std::istream & inputStream__cdg,
                                            const cmnDataFormat & localFormat,
                                            const cmnDataFormat & remoteFormat) throw (std::runtime_error) {
    cmnData<std::string >::DeSerializeBinary(this->ProcessName, inputStream__cdg, localFormat, remoteFormat);
    cmnData<std::string >::DeSerializeBinary(this->ComponentName, inputStream__cdg, localFormat, remoteFormat);
...
void mtsDescriptionIntefaceFullName::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsDescriptionIntefaceFullName::SerializeDescription(const char delimiter__cdg, const std::string & userDescription__cdg) const {
    bool someData__cdg = false;
    const std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    std::stringstream description__cdg;
    if (someData__cdg) {
...
void mtsDescriptionIntefaceFullName::DeSerializeText(std::istream & inputStream__cdg,
                                          const char delimiter__cdg) throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        cmnDataDeSerializeTextDelimiter(inputStream__cdg, delimiter__cdg, "mtsDescriptionIntefaceFullName");
    }
    someData__cdg = true;
    cmnData<std::string >::DeSerializeText(this->ProcessName, inputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
...
std::string mtsDescriptionIntefaceFullName::HumanReadable(void) const {
    std::stringstream description__cdg;
    description__cdg << "mtsDescriptionIntefaceFullName" << std::endl;
    description__cdg << "  ProcessName:" << cmnData<std::string >::HumanReadable(this->ProcessName);
    description__cdg << "  ComponentName:" << cmnData<std::string >::HumanReadable(this->ComponentName);
...
std::string mtsDescriptionIntefaceFullName::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
...
double mtsDescriptionIntefaceFullName::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsDescriptionConnection::Copy(const mtsDescriptionConnection & source__cdg) {
    cmnData<mtsDescriptionIntefaceFullName >::Copy(this->Client, source__cdg.Client);
    cmnData<mtsDescriptionIntefaceFullName >::Copy(this->Server, source__cdg.Server);
    cmnData<ConnectionIDType >::Copy(this->ConnectionID, source__cdg.ConnectionID);
}
void mtsDescriptionConnection::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<mtsDescriptionIntefaceFullName >::SerializeBinary(this->Client, outputStream__cdg);
    cmnData<mtsDescriptionIntefaceFullName >::SerializeBinary(this->Server, outputStream__cdg);
...
void mtsDescriptionConnection::DeSerializeBinary(std::istream & inputStream__cdg,
                                            const cmnDataFormat & localFormat,
                                            const cmnDataFormat & remoteFormat) throw (std::runtime_error) {
    cmnData<mtsDescriptionIntefaceFullName >::DeSerializeBinary(this->Client, inputStream__cdg, localFormat, remoteFormat);
    cmnData<mtsDescriptionIntefaceFullName >::DeSerializeBinary(this->Server, inputStream__cdg, localFormat, remoteFormat);
    cmnData<ConnectionIDType >::DeSerializeBinary(this->ConnectionID, inputStream__cdg, localFormat, remoteFormat);
}
void mtsDescriptionConnection::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
    someData__cdg = true;
    cmnData<mtsDescriptionIntefaceFullName >::SerializeText(this->Client, outputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
    someData__cdg = true;
    cmnData<mtsDescriptionIntefaceFullName >::SerializeText(this->Server, outputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
    someData__cdg = true;
...
std::string mtsDescriptionConnection::SerializeDescription(const char delimiter__cdg, const std::string & userDescription__cdg) const {
    ...
    someData__cdg = true;
    description__cdg << cmnData<mtsDescriptionIntefaceFullName >::SerializeDescription(this->Client, delimiter__cdg, prefix__cdg + "Client");
    if (someData__cdg) {
        description__cdg << delimiter__cdg;
    }
    someData__cdg = true;
    description__cdg << cmnData<mtsDescriptionIntefaceFullName >::SerializeDescription(this->Server, delimiter__cdg, prefix__cdg + "Server");
    if (someData__cdg) {
        description__cdg << delimiter__cdg;
    }
    someData__cdg = true;
...
void mtsDescriptionConnection::DeSerializeText(std::istream & inputStream__cdg,
    ...
    someData__cdg = true;
    cmnData<mtsDescriptionIntefaceFullName >::DeSerializeText(this->Client, inputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
        cmnDataDeSerializeTextDelimiter(inputStream__cdg, delimiter__cdg, "mtsDescriptionConnection");
    }
    someData__cdg = true;
    cmnData<mtsDescriptionIntefaceFullName >::DeSerializeText(this->Server, inputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
        cmnDataDeSerializeTextDelimiter(inputStream__cdg, delimiter__cdg, "mtsDescriptionConnection");
    }
    someData__cdg = true;
...
std::string mtsDescriptionConnection::HumanReadable(void) const {
    ...
    description__cdg << "  Client:" << cmnData<mtsDescriptionIntefaceFullName >::HumanReadable(this->Client);
    description__cdg << "  Server:" << cmnData<mtsDescriptionIntefaceFullName >::HumanReadable(this->Server);
...
std::string mtsDescriptionConnection::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsDescriptionIntefaceFullName >::ScalarNumber(this->Client);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<mtsDescriptionIntefaceFullName >::ScalarDescription(this->Client, index_cdg - baseIndex__cdg, prefix__cdg + "Client");
    }
    baseIndex__cdg = currentMaxIndex__cdg;
    currentMaxIndex__cdg += cmnData<mtsDescriptionIntefaceFullName >::ScalarNumber(this->Server);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<mtsDescriptionIntefaceFullName >::ScalarDescription(this->Server, index_cdg - baseIndex__cdg, prefix__cdg + "Server");
    }
    baseIndex__cdg = currentMaxIndex__cdg;
...
double mtsDescriptionConnection::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsDescriptionIntefaceFullName >::ScalarNumber(this->Client);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<mtsDescriptionIntefaceFullName >::Scalar(this->Client, index_cdg - baseIndex__cdg);
    }
    baseIndex__cdg = currentMaxIndex__cdg;
    currentMaxIndex__cdg += cmnData<mtsDescriptionIntefaceFullName >::ScalarNumber(this->Server);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<mtsDescriptionIntefaceFullName >::Scalar(this->Server, index_cdg - baseIndex__cdg);
    }
    baseIndex__cdg = currentMaxIndex__cdg;
    currentMaxIndex__cdg += cmnData<ConnectionIDType >::ScalarNumber(this->ConnectionID);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsDescriptionConnection::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        cmnDataJSON<mtsDescriptionIntefaceFullName >::DeSerializeText(this->Client, field__cdg);
    } else {
        cmnThrow("cmnDataJson<mtsDescriptionIntefaceFullName>::DeSerializeText: empty JSON value for: Client");
    };
    field__cdg = jsonValue["Server"];
    if (!field__cdg.empty()) {
        cmnDataJSON<mtsDescriptionIntefaceFullName >::DeSerializeText(this->Server, field__cdg);
    } else {
        cmnThrow("cmnDataJson<mtsDescriptionIntefaceFullName>::DeSerializeText: empty JSON value for: Server");
    };
...
void mtsComponentStatusControl::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<std::string >::SerializeBinary(this->ProcessName, outputStream__cdg);
    cmnData<std::string >::SerializeBinary(this->ComponentName, outputStream__cdg);
...
void mtsComponentStatusControl::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsComponentStatusControl::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
...
double mtsComponentStatusControl::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsComponentStateChange::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<std::string >::SerializeBinary(this->ProcessName, outputStream__cdg);
    cmnData<std::string >::SerializeBinary(this->ComponentName, outputStream__cdg);
...
void mtsComponentStateChange::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsComponentStateChange::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
...
double mtsComponentStateChange::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsDescriptionLoadLibrary::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<std::string >::SerializeBinary(this->ProcessName, outputStream__cdg);
...
void mtsDescriptionLoadLibrary::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsDescriptionLoadLibrary::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
...
double mtsDescriptionLoadLibrary::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->ProcessName);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsEndUserInterfaceArg::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void mtsEndUserInterfaceArg::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsEndUserInterfaceArg::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
...
double mtsEndUserInterfaceArg::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<size_t >::ScalarNumber(this->OriginalInterface);
    if (index_cdg < currentMaxIndex__cdg) {
...
void mtsMessage::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void mtsMessage::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsMessage::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
...
double mtsMessage::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<std::string >::ScalarNumber(this->Message);
    if (index_cdg < currentMaxIndex__cdg) {
...
template<>
void cmnDataJSON<mtsMessage >::DeSerializeText(mtsMessage & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void mtsMessage::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
    Json::Value field__cdg;
...
void mtsTaskContinuousConstructorArg::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void mtsTaskContinuousConstructorArg::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsTaskContinuousConstructorArg::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
...
double mtsTaskContinuousConstructorArg::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsGenericObject >::ScalarNumber(*this);
    if (index_cdg < currentMaxIndex__cdg) {
...
template<>
void cmnDataJSON<mtsTaskContinuousConstructorArg >::DeSerializeText(mtsTaskContinuousConstructorArg & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void mtsTaskContinuousConstructorArg::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
...
void mtsTaskPeriodicConstructorArg::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<mtsGenericObject >::SerializeBinary(*this, outputStream__cdg);
    cmnData<std::string >::SerializeBinary(this->Name, outputStream__cdg);
...
void mtsTaskPeriodicConstructorArg::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsTaskPeriodicConstructorArg::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsGenericObject >::ScalarNumber(*this);
...
double mtsTaskPeriodicConstructorArg::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsGenericObject >::ScalarNumber(*this);
    if (index_cdg < currentMaxIndex__cdg) {
...
template<>
void cmnDataJSON<mtsTaskPeriodicConstructorArg >::DeSerializeText(mtsTaskPeriodicConstructorArg & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void mtsTaskPeriodicConstructorArg::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
    cmnDataJSON<mtsGenericObject >::DeSerializeText(*(dynamic_cast<mtsGenericObject*>(this)), jsonValue);
    Json::Value field__cdg;
    field__cdg = jsonValue["Name"];
    if (!field__cdg.empty()) {
