...
// cisst version: 1.0.9
// source file: /home/jiameng/catkin_dvrk/src/cisst-saw/cisst/cisstMultiTask/code/../mtsExecutionResult.cdg
...
void mtsExecutionResult::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void mtsExecutionResult::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
...
std::string mtsExecutionResult::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
...
double mtsExecutionResult::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsExecutionResult::Enum >::ScalarNumber(this->mValue);
    if (index_cdg < currentMaxIndex__cdg) {
