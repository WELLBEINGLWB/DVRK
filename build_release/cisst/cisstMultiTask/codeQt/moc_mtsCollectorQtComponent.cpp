...
const QMetaObject mtsCollectorQtComponent::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mtsCollectorQtComponent.data,
      qt_meta_data_mtsCollectorQtComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    QMetaObject::activate(const_cast< mtsCollectorQtComponent *>(this), &staticMetaObject, 0, Q_NULLPTR);
}
