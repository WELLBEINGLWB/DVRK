...
const QMetaObject mtsIntervalStatisticsQtWidget::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata_mtsIntervalStatisticsQtWidget.data,
      qt_meta_data_mtsIntervalStatisticsQtWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mtsIntervalStatisticsQtWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mtsIntervalStatisticsQtWidget.stringdata0))
        return static_cast<void*>(const_cast< mtsIntervalStatisticsQtWidget*>(this));
...
void mtsIntervalStatisticsQtWidgetComponent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        mtsIntervalStatisticsQtWidgetComponent *_t = static_cast<mtsIntervalStatisticsQtWidgetComponent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject mtsIntervalStatisticsQtWidgetComponent::staticMetaObject = {
    { &mtsIntervalStatisticsQtWidget::staticMetaObject, qt_meta_stringdata_mtsIntervalStatisticsQtWidgetComponent.data,
      qt_meta_data_mtsIntervalStatisticsQtWidgetComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mtsIntervalStatisticsQtWidgetComponent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mtsIntervalStatisticsQtWidgetComponent.stringdata0))
        return static_cast<void*>(const_cast< mtsIntervalStatisticsQtWidgetComponent*>(this));
    if (!strcmp(_clname, "mtsComponent"))
        return static_cast< mtsComponent*>(const_cast< mtsIntervalStatisticsQtWidgetComponent*>(this));
