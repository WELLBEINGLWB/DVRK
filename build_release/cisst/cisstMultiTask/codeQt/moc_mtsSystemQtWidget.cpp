...
const QMetaObject mtsSystemQtWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_mtsSystemQtWidget.data,
      qt_meta_data_mtsSystemQtWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mtsSystemQtWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mtsSystemQtWidget.stringdata0))
        return static_cast<void*>(const_cast< mtsSystemQtWidget*>(this));
...
void mtsSystemQtWidgetComponent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        mtsSystemQtWidgetComponent *_t = static_cast<mtsSystemQtWidgetComponent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject mtsSystemQtWidgetComponent::staticMetaObject = {
    { &mtsSystemQtWidget::staticMetaObject, qt_meta_stringdata_mtsSystemQtWidgetComponent.data,
      qt_meta_data_mtsSystemQtWidgetComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mtsSystemQtWidgetComponent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mtsSystemQtWidgetComponent.stringdata0))
        return static_cast<void*>(const_cast< mtsSystemQtWidgetComponent*>(this));
    if (!strcmp(_clname, "mtsComponent"))
        return static_cast< mtsComponent*>(const_cast< mtsSystemQtWidgetComponent*>(this));
