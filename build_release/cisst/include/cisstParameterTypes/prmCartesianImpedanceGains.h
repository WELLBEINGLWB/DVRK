...
template <> void CISST_EXPORT cmnDataJSON<prmCartesianImpedanceGains >::DeSerializeText(prmCartesianImpedanceGains & data, const Json::Value & jsonValue) throw (std::runtime_error);
#endif // CISST_HAS_JSON
