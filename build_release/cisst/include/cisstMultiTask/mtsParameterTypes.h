...
template <> void CISST_EXPORT cmnDataJSON<mtsMessage >::DeSerializeText(mtsMessage & data, const Json::Value & jsonValue) throw (std::runtime_error);
#endif // CISST_HAS_JSON
...
template <> void CISST_EXPORT cmnDataJSON<mtsTaskContinuousConstructorArg >::DeSerializeText(mtsTaskContinuousConstructorArg & data, const Json::Value & jsonValue) throw (std::runtime_error);
#endif // CISST_HAS_JSON
...
template <> void CISST_EXPORT cmnDataJSON<mtsTaskPeriodicConstructorArg >::DeSerializeText(mtsTaskPeriodicConstructorArg & data, const Json::Value & jsonValue) throw (std::runtime_error);
#endif // CISST_HAS_JSON
