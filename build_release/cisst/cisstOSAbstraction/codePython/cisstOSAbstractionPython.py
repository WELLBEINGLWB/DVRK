...
class ios(ios_base):
    ...
    def __init__(self, __sb):
        this = _cisstOSAbstractionPython.new_ios(__sb)
        try:
...
class ostream(ios):
    ...
    def __init__(self, __sb):
        this = _cisstOSAbstractionPython.new_ostream(__sb)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class istream(ios):
    ...
    def __init__(self, __sb):
        this = _cisstOSAbstractionPython.new_istream(__sb)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class iostream(istream, ostream):
    ...
    def __init__(self, __sb):
        this = _cisstOSAbstractionPython.new_iostream(__sb)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
_cisstOSAbstractionPython.endl_cb_ptr_swigconstant(_cisstOSAbstractionPython)
endl_cb_ptr = _cisstOSAbstractionPython.endl_cb_ptr

def endl(arg1):
    return _cisstOSAbstractionPython.endl(arg1)
endl = _cisstOSAbstractionPython.endl

_cisstOSAbstractionPython.ends_cb_ptr_swigconstant(_cisstOSAbstractionPython)
ends_cb_ptr = _cisstOSAbstractionPython.ends_cb_ptr

def ends(arg1):
    return _cisstOSAbstractionPython.ends(arg1)
ends = _cisstOSAbstractionPython.ends

_cisstOSAbstractionPython.flush_cb_ptr_swigconstant(_cisstOSAbstractionPython)
flush_cb_ptr = _cisstOSAbstractionPython.flush_cb_ptr

def flush(arg1):
    return _cisstOSAbstractionPython.flush(arg1)
