...
const QMetaObject prmStateRobotQtWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_prmStateRobotQtWidget.data,
      qt_meta_data_prmStateRobotQtWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *prmStateRobotQtWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_prmStateRobotQtWidget.stringdata0))
        return static_cast<void*>(const_cast< prmStateRobotQtWidget*>(this));
...
void prmStateRobotQtWidgetComponent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        prmStateRobotQtWidgetComponent *_t = static_cast<prmStateRobotQtWidgetComponent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject prmStateRobotQtWidgetComponent::staticMetaObject = {
    { &prmStateRobotQtWidget::staticMetaObject, qt_meta_stringdata_prmStateRobotQtWidgetComponent.data,
      qt_meta_data_prmStateRobotQtWidgetComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *prmStateRobotQtWidgetComponent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_prmStateRobotQtWidgetComponent.stringdata0))
        return static_cast<void*>(const_cast< prmStateRobotQtWidgetComponent*>(this));
    if (!strcmp(_clname, "mtsComponent"))
        return static_cast< mtsComponent*>(const_cast< prmStateRobotQtWidgetComponent*>(this));
