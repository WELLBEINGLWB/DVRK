...
void prmEventButtonQtWidgetComponent_ButtonData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        prmEventButtonQtWidgetComponent_ButtonData *_t = static_cast<prmEventButtonQtWidgetComponent_ButtonData *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (prmEventButtonQtWidgetComponent_ButtonData::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&prmEventButtonQtWidgetComponent_ButtonData::SetValueSignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject prmEventButtonQtWidgetComponent_ButtonData::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_prmEventButtonQtWidgetComponent_ButtonData.data,
      qt_meta_data_prmEventButtonQtWidgetComponent_ButtonData,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *prmEventButtonQtWidgetComponent_ButtonData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_prmEventButtonQtWidgetComponent_ButtonData.stringdata0))
        return static_cast<void*>(const_cast< prmEventButtonQtWidgetComponent_ButtonData*>(this));
...
const QMetaObject prmEventButtonQtWidgetComponent::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_prmEventButtonQtWidgetComponent.data,
      qt_meta_data_prmEventButtonQtWidgetComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *prmEventButtonQtWidgetComponent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_prmEventButtonQtWidgetComponent.stringdata0))
        return static_cast<void*>(const_cast< prmEventButtonQtWidgetComponent*>(this));
    if (!strcmp(_clname, "mtsComponent"))
        return static_cast< mtsComponent*>(const_cast< prmEventButtonQtWidgetComponent*>(this));
