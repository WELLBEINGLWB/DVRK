...
// cisst version: 1.0.9
// source file: /home/jiameng/catkin_dvrk/src/cisst-saw/cisst/cisstParameterTypes/code/../prmCartesianImpedanceGains.cdg
...
void prmCartesianImpedanceGains::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void prmCartesianImpedanceGains::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
...
std::string prmCartesianImpedanceGains::HumanReadable(void) const {
    ...
    description__cdg << "  Force orientation matrix:" << cmnData<vctMatRot3 >::HumanReadable(this->mForceOrientation);
    description__cdg << "  Force position vector:" << cmnData<vct3 >::HumanReadable(this->mForcePosition);
    description__cdg << "  Torque orientation matrix:" << cmnData<vctMatRot3 >::HumanReadable(this->mTorqueOrientation);
    description__cdg << "  Positive position stiffness vector:" << cmnData<vct3 >::HumanReadable(this->mPositionStiffnessPos);
    description__cdg << "  Negative position stiffness vector:" << cmnData<vct3 >::HumanReadable(this->mPositionStiffnessNeg);
    description__cdg << "  Positive position damping vector:" << cmnData<vct3 >::HumanReadable(this->mPositionDampingPos);
    description__cdg << "  Negative position damping vector:" << cmnData<vct3 >::HumanReadable(this->mPositionDampingNeg);
    description__cdg << "  Positive force bias vector:" << cmnData<vct3 >::HumanReadable(this->mForceBiasPos);
    description__cdg << "  Negative force bias vector:" << cmnData<vct3 >::HumanReadable(this->mForceBiasNeg);
    description__cdg << "  Positive orientation stiffness vector:" << cmnData<vct3 >::HumanReadable(this->mOrientationStiffnessPos);
    description__cdg << "  Negative orientation stiffness vector:" << cmnData<vct3 >::HumanReadable(this->mOrientationStiffnessNeg);
    description__cdg << "  Positive orientation damping vector:" << cmnData<vct3 >::HumanReadable(this->mOrientationDampingPos);
    description__cdg << "  Positive orientation damping vector:" << cmnData<vct3 >::HumanReadable(this->mOrientationDampingNeg);
    description__cdg << "  Positive torque bias vector:" << cmnData<vct3 >::HumanReadable(this->mTorqueBiasPos);
    description__cdg << "  Negative torque bias vector:" << cmnData<vct3 >::HumanReadable(this->mTorqueBiasNeg);
    return description__cdg.str();
}
...
std::string prmCartesianImpedanceGains::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
...
double prmCartesianImpedanceGains::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsGenericObject >::ScalarNumber(*this);
    if (index_cdg < currentMaxIndex__cdg) {
...
template<>
void cmnDataJSON<prmCartesianImpedanceGains >::DeSerializeText(prmCartesianImpedanceGains & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void prmCartesianImpedanceGains::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
