...
void prmPositionCartesianGet::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void prmPositionCartesianGet::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
...
std::string prmPositionCartesianGet::HumanReadable(void) const {
    ...
    description__cdg << "  Name of moving frame:" << cmnData<std::string >::HumanReadable(this->mMovingFrame);
    description__cdg << "  Name reference frame:" << cmnData<std::string >::HumanReadable(this->mReferenceFrame);
    description__cdg << "  Desired position:" << cmnData<vctFrm3 >::HumanReadable(this->mPosition);
    return description__cdg.str();
}
...
std::string prmPositionCartesianGet::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
...
double prmPositionCartesianGet::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsGenericObject >::ScalarNumber(*this);
    if (index_cdg < currentMaxIndex__cdg) {
