...
// cisst version: 1.0.9
// source file: /home/jiameng/catkin_dvrk/src/cisst-saw/cisst/cisstParameterTypes/code/../prmIMUSensors.cdg
...
void prmIMUSensors::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void prmIMUSensors::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
...
std::string prmIMUSensors::HumanReadable(void) const {
    ...
    description__cdg << "  Accelerometer, units m/s*s:" << cmnData<vct3 >::HumanReadable(this->mAccel);
    description__cdg << "  Gyroscope, units rad/s:" << cmnData<vct3 >::HumanReadable(this->mGyro);
    description__cdg << "  Magnetometer, units G (Gauss):" << cmnData<vct3 >::HumanReadable(this->mMag);
    description__cdg << "  Temperature, units deg-C:" << cmnData<double >::HumanReadable(this->mTemp);
    description__cdg << "  Barometric pressure, units kPa (kilo-Pascal):" << cmnData<double >::HumanReadable(this->mPressure);
    return description__cdg.str();
}
...
std::string prmIMUSensors::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
...
double prmIMUSensors::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsGenericObject >::ScalarNumber(*this);
    if (index_cdg < currentMaxIndex__cdg) {
