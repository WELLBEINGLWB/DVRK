...
// cisst version: 1.0.9
// source file: /home/jiameng/catkin_dvrk/src/cisst-saw/cisst/cisstParameterTypes/code/../prmInputData.cdg
...
void prmInputData::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void prmInputData::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
...
std::string prmInputData::HumanReadable(void) const {
    ...
    description__cdg << "  Analog inputs:" << cmnData<vctDoubleVec >::HumanReadable(this->mAnalogInputs);
    description__cdg << "  Digital inputs:" << cmnData<vctBoolVec >::HumanReadable(this->mDigitalInputs);
    return description__cdg.str();
}
...
std::string prmInputData::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
...
double prmInputData::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsGenericObject >::ScalarNumber(*this);
    if (index_cdg < currentMaxIndex__cdg) {
...
template<>
void cmnDataJSON<prmInputData >::DeSerializeText(prmInputData & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void prmInputData::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
