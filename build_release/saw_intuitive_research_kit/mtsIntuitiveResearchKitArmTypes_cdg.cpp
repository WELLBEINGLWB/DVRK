...
// cisst version: 1.0.9
// source file: /home/jiameng/catkin_dvrk/src/cisst-saw/sawIntuitiveResearchKit/components/code/mtsIntuitiveResearchKitArmTypes.cdg
...
void mtsIntuitiveResearchKitArmTypes::SerializeBinary(std::ostream & CMN_UNUSED(outputStream__cdg)) const throw (std::runtime_error) {
}
...
void mtsIntuitiveResearchKitArmTypes::SerializeText(std::ostream & CMN_UNUSED(outputStream__cdg), const char CMN_UNUSED(delimiter__cdg)) const throw (std::runtime_error) {
}
...
std::string mtsIntuitiveResearchKitArmTypes::ScalarDescription(const size_t CMN_UNUSED(index_cdg), const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    cmnThrow(std::out_of_range("cmnDataScalarDescription: mtsIntuitiveResearchKitArmTypes index out of range"));
    return "";
}
double mtsIntuitiveResearchKitArmTypes::Scalar(const size_t CMN_UNUSED(index_cdg)) const throw (std::out_of_range) {
...
std::string mtsIntuitiveResearchKitArmTypes::ControlSpaceToString(const mtsIntuitiveResearchKitArmTypes::ControlSpace & data) throw (std::runtime_error) {
    switch (data) {
        case mtsIntuitiveResearchKitArmTypes::UNDEFINED_SPACE:
            return "UNDEFINED_SPACE";
            break;
...
mtsIntuitiveResearchKitArmTypes::ControlSpace mtsIntuitiveResearchKitArmTypes::ControlSpaceFromString(const std::string & value) throw (std::runtime_error) {
    ...
    cmnThrow("mtsIntuitiveResearchKitArmTypes::ControlSpaceFromString can't find matching enum for " + value);
...
std::string mtsIntuitiveResearchKitArmTypes::ControlModeToString(const mtsIntuitiveResearchKitArmTypes::ControlMode & data) throw (std::runtime_error) {
    switch (data) {
        case mtsIntuitiveResearchKitArmTypes::UNDEFINED_MODE:
            return "UNDEFINED_MODE";
            break;
...
mtsIntuitiveResearchKitArmTypes::ControlMode mtsIntuitiveResearchKitArmTypes::ControlModeFromString(const std::string & value) throw (std::runtime_error) {
    ...
    cmnThrow("mtsIntuitiveResearchKitArmTypes::ControlModeFromString can't find matching enum for " + value);
