...
// cisst version: 1.0.9
// source file: /home/jiameng/catkin_dvrk/src/cisst-saw/sawIntuitiveResearchKit/components/code/socketMessages.cdg
...
void socketMessages::SerializeBinary(std::ostream & CMN_UNUSED(outputStream__cdg)) const throw (std::runtime_error) {
}
...
void socketMessages::SerializeText(std::ostream & CMN_UNUSED(outputStream__cdg), const char CMN_UNUSED(delimiter__cdg)) const throw (std::runtime_error) {
}
...
std::string socketMessages::ScalarDescription(const size_t CMN_UNUSED(index_cdg), const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    cmnThrow(std::out_of_range("cmnDataScalarDescription: socketMessages index out of range"));
    return "";
}
double socketMessages::Scalar(const size_t CMN_UNUSED(index_cdg)) const throw (std::out_of_range) {
...
template<>
void cmnDataJSON<socketMessages >::DeSerializeText(socketMessages & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void socketMessages::DeSerializeTextJSON(const Json::Value & CMN_UNUSED(jsonValue)) throw (std::runtime_error) {
...
std::string socketMessages::StateTypeToString(const socketMessages::StateType & data) throw (std::runtime_error) {
    switch (data) {
        case socketMessages::SCK_UNINITIALIZED:
...
socketMessages::StateType socketMessages::StateTypeFromString(const std::string & value) throw (std::runtime_error) {
    ...
    cmnThrow("socketMessages::StateTypeFromString can't find matching enum for " + value);
...
void socketHeader::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void socketHeader::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
...
std::string socketHeader::HumanReadable(void) const {
    ...
    description__cdg << "  Version number. 10000 stands for 1.00.00:" << cmnData<int >::HumanReadable(this->Version);
    description__cdg << "  Message id counter. Increment by 1 and the first packet number starts with 0:" << cmnData<unsigned int >::HumanReadable(this->Id);
    description__cdg << "  Message size in bytes, including the header:" << cmnData<int >::HumanReadable(this->Size);
    description__cdg << "  Local timestamp in seconds:" << cmnData<double >::HumanReadable(this->Timestamp);
    description__cdg << "  Last Message id received:" << cmnData<unsigned int >::HumanReadable(this->LastId);
    description__cdg << "  Timestamp in seconds of the last message received:" << cmnData<double >::HumanReadable(this->LastTimestamp);
    return description__cdg.str();
}
...
std::string socketHeader::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
...
double socketHeader::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<int >::ScalarNumber(this->Version);
    if (index_cdg < currentMaxIndex__cdg) {
...
template<>
void cmnDataJSON<socketHeader >::DeSerializeText(socketHeader & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void socketHeader::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
    Json::Value field__cdg;
...
void socketStatePSM::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
...
void socketStatePSM::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string socketStatePSM::HumanReadable(void) const {
    ...
    description__cdg << "  Current State of the arm:" << cmnData<socketMessages::StateType >::HumanReadable(this->RobotControlState);
    description__cdg << "  Current pose of the arm:" << cmnData<vctFrm3 >::HumanReadable(this->CurrentPose);
    description__cdg << "  Current jaw position of the arm:" << cmnData<double >::HumanReadable(this->CurrentJaw);
    return description__cdg.str();
}
...
std::string socketStatePSM::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
...
double socketStatePSM::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<socketHeader >::ScalarNumber(this->Header);
    if (index_cdg < currentMaxIndex__cdg) {
...
template<>
void cmnDataJSON<socketStatePSM >::DeSerializeText(socketStatePSM & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void socketStatePSM::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
    Json::Value field__cdg;
...
void socketCommandPSM::SerializeBinary(std::ostream & outputStream__cdg) const throw (std::runtime_error) {
    cmnData<socketHeader >::SerializeBinary(this->Header, outputStream__cdg);
    cmnData<socketMessages::StateType >::SerializeBinary(this->RobotControlState, outputStream__cdg);
...
void socketCommandPSM::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const throw (std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string socketCommandPSM::HumanReadable(void) const {
    ...
    description__cdg << "  Header:" << cmnData<socketHeader >::HumanReadable(this->Header);
    description__cdg << "  Desired State of the arm:" << cmnData<socketMessages::StateType >::HumanReadable(this->RobotControlState);
    description__cdg << "  Desired pose of the arm:" << cmnData<vctFrm3 >::HumanReadable(this->GoalPose);
    description__cdg << "  Desired jaw position of the arm:" << cmnData<double >::HumanReadable(this->GoalJaw);
    return description__cdg.str();
}
...
std::string socketCommandPSM::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const throw (std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<socketHeader >::ScalarNumber(this->Header);
...
double socketCommandPSM::Scalar(const size_t index_cdg) const throw (std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<socketHeader >::ScalarNumber(this->Header);
    if (index_cdg < currentMaxIndex__cdg) {
...
template<>
void cmnDataJSON<socketCommandPSM >::DeSerializeText(socketCommandPSM & data, const Json::Value & jsonValue) throw (std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void socketCommandPSM::DeSerializeTextJSON(const Json::Value & jsonValue) throw (std::runtime_error) {
    Json::Value field__cdg;
    field__cdg = jsonValue["Header"];
    if (!field__cdg.empty()) {
        cmnDataJSON<socketHeader >::DeSerializeText(this->Header, field__cdg);
