...
public:
    ...
    static std::string ControlSpaceToString(const ControlSpace & value) throw (std::runtime_error);
    static ControlSpace ControlSpaceFromString(const std::string & value) throw (std::runtime_error);
...
public:
    ...
    static std::string ControlModeToString(const ControlMode & value) throw (std::runtime_error);
    static ControlMode ControlModeFromString(const std::string & value) throw (std::runtime_error);
