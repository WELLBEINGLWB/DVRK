...
public:
    ...
    static std::string StateTypeToString(const StateType & value) throw (std::runtime_error);
    static StateType StateTypeFromString(const std::string & value) throw (std::runtime_error);
...
template <> void  cmnDataJSON<socketMessages >::DeSerializeText(socketMessages & data, const Json::Value & jsonValue) throw (std::runtime_error);
#endif // CISST_HAS_JSON
...
template <> void CISST_EXPORT cmnDataJSON<socketHeader >::DeSerializeText(socketHeader & data, const Json::Value & jsonValue) throw (std::runtime_error);
#endif // CISST_HAS_JSON
...
template <> void CISST_EXPORT cmnDataJSON<socketStatePSM >::DeSerializeText(socketStatePSM & data, const Json::Value & jsonValue) throw (std::runtime_error);
#endif // CISST_HAS_JSON
...
template <> void CISST_EXPORT cmnDataJSON<socketCommandPSM >::DeSerializeText(socketCommandPSM & data, const Json::Value & jsonValue) throw (std::runtime_error);
#endif // CISST_HAS_JSON
