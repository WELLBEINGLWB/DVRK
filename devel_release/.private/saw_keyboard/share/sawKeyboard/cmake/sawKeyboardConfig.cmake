...
set (sawKeyboard_VERSION "1.2.0")

# figure out if this file is where it was configured (build tree) or
# not (installed tree)
set (sawKeyboard_CMAKE_CONFIG_FILE "/home/jiameng/catkin_dvrk/devel_release/.private/saw_keyboard/share/sawKeyboard/cmake/sawKeyboardConfig.cmake")
...
if ("${sawKeyboard_CMAKE_CONFIG_FILE}" STREQUAL "${THIS_FILE_PATH}")
  ...
  set (sawKeyboard_INCLUDE_DIR "/home/jiameng/catkin_dvrk/src/cisst-saw/sawKeyboard/components/include;/home/jiameng/catkin_dvrk/build_release/saw_keyboard/include")
  set (sawKeyboard_LIBRARY_DIR "/home/jiameng/catkin_dvrk/devel_release/.private/saw_keyboard/lib")
else ()
