...
if("TRUE" STREQUAL "TRUE")
  set(rqt_dvrk_SOURCE_PREFIX /home/jiameng/catkin_dvrk/src/dvrk-ros/deprecated/rqt_dvrk)
  set(rqt_dvrk_DEVEL_PREFIX /home/jiameng/catkin_dvrk/devel_release/.private/rqt_dvrk)
  set(rqt_dvrk_INSTALL_PREFIX "")
  set(rqt_dvrk_PREFIX ${rqt_dvrk_DEVEL_PREFIX})
else()
  set(rqt_dvrk_SOURCE_PREFIX "")
  set(rqt_dvrk_DEVEL_PREFIX "")
  set(rqt_dvrk_INSTALL_PREFIX /home/jiameng/catkin_dvrk/install_release)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rqt_dvrk' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rqt_dvrk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jiameng/catkin_dvrk/src/dvrk-ros/deprecated/rqt_dvrk/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jiameng/catkin_dvrk/devel_release/.private/rqt_dvrk/lib;/home/jiameng/catkin_dvrk/devel_release/lib;/home/jiameng/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rqt_dvrk_dep}_FOUND)
      find_package(${rqt_dvrk_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rqt_dvrk_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
