// Generated by gencpp from file cisst_msgs/prmCartesianImpedanceGains.msg
// DO NOT EDIT!


#ifndef CISST_MSGS_MESSAGE_PRMCARTESIANIMPEDANCEGAINS_H
#define CISST_MSGS_MESSAGE_PRMCARTESIANIMPEDANCEGAINS_H
...
struct prmCartesianImpedanceGains_
{
  typedef prmCartesianImpedanceGains_<ContainerAllocator> Type;

  prmCartesianImpedanceGains_()
    : header()
    , ForceOrientation()
    , ForcePosition()
    , TorqueOrientation()
  ...
  prmCartesianImpedanceGains_(const ContainerAllocator& _alloc)
    : header(_alloc)
  ...
  typedef boost::shared_ptr< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> const> ConstPtr;

}; // struct prmCartesianImpedanceGains_

typedef ::cisst_msgs::prmCartesianImpedanceGains_<std::allocator<void> > prmCartesianImpedanceGains;

typedef boost::shared_ptr< ::cisst_msgs::prmCartesianImpedanceGains > prmCartesianImpedanceGainsPtr;
typedef boost::shared_ptr< ::cisst_msgs::prmCartesianImpedanceGains const> prmCartesianImpedanceGainsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe52654ad70465afaULL;
  static const uint64_t static_value2 = 0x307bde13463e05e5ULL;
};

template<class ContainerAllocator>
struct DataType< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // CISST_MSGS_MESSAGE_PRMCARTESIANIMPEDANCEGAINS_H
