...
set (sawControllers_VERSION "1.5.0")

# figure out if this file is where it was configured (build tree) or
# not (installed tree)
set (sawControllers_CMAKE_CONFIG_FILE "/home/jiameng/catkin_dvrk/devel_release/.private/saw_controllers/share/sawControllers/cmake/sawControllersConfig.cmake")
...
if ("${sawControllers_CMAKE_CONFIG_FILE}" STREQUAL "${THIS_FILE_PATH}")
  ...
  set (sawControllers_INCLUDE_DIR "/home/jiameng/catkin_dvrk/src/cisst-saw/sawControllers/components/include;/home/jiameng/catkin_dvrk/build_release/saw_controllers/include")
  set (sawControllers_LIBRARY_DIR "/home/jiameng/catkin_dvrk/build_release/saw_controllers/lib")
else ()
